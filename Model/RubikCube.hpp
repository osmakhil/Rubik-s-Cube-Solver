...
/*
A base class for all Rubik's cube model. There are varios representation of Rubik's cube
Each one has it's own functionality and definitions. This class shared commoon functionality
between models
*/
